...
DATA="$DATA_ROOT/libero_10_hard2_t8_h50p15_worldh15_qwen08_last6_denseall_v8.pt"
SOURCE=/root/ora0_ckpts/libero_10_hard2_denseall_worldh15_qwen08_last6_continue_e5_b16_v8.pt
SAVE=/root/ora0_ckpts/libero_10_hard2_t8_denseall_worldh15_qwen08_last6_continue_e4_b8_v9.pt
LOG="$DATA_ROOT/logs/libero_10_hard2_t8_denseall_worldh15_qwen08_last6_continue_e4_b8_v9.log"
...
common=(
  ...
  --epochs 4 --stage1-steps 0
  --batch-size 8 --mixed-tasks 2 --anchor-fraction 0
