...
DATA="$DATA_ROOT/libero_10_hard2_t3_t4_dualview5_h50p15_v2.pt"
SAVE=/root/ora0_ckpts/libero_10_hard2_t3_t4_dualview5_scratch_h50p15_twostage_e50_b16_v3.pt
LOG="$DATA_ROOT/logs/libero_10_hard2_t3_t4_dualview5_scratch_h50p15_twostage_e50_b16_v3.log"
...
common=(
  ...
  --qwen-lora-rank 16 --prev-dropout 1 --encode-batch 32
